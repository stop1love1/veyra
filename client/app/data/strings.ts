...
export const STR: Record<string, Localized> = {
  ...
  passport:       { vi: 'Hộ chiếu Veyra',          en: 'Veyra Passport' },
  passportLoc:    { vi: 'Hồ sơ cư dân · Veyra Plaza', en: 'Resident profile · Veyra Plaza' },
  pillars:        { vi: 'Trụ cột',                  en: 'Pillars' },
  unlocked:       { vi: 'Đã mở',                    en: 'Unlocked' },
  noRewards:      { vi: 'Chưa có phần thưởng',      en: 'No rewards yet' },
  streak:         { vi: 'Chuỗi ngày',               en: 'Day streak' },
  leaderboard:    { vi: 'Xếp hạng',                 en: 'Leaderboard' },
  you:            { vi: 'Bạn',                       en: 'You' },
  collections:    { vi: 'Bộ sưu tập',               en: 'Collections' },
  styled:         { vi: 'Đã phối',                  en: 'Styled' },
  owned:          { vi: 'Đã sở hữu',                en: 'Owned' },
  inviteFriends:  { vi: 'Mời bạn bè',               en: 'Invite friends' },
  inviteHint:     { vi: 'Bạn bè vào Veyra qua link này — khi họ đạt Rank 2, cả hai cùng nhận thưởng.', en: 'Friends who join via your link earn you both a reward once they reach Rank 2.' },
  share:          { vi: 'Chia sẻ link',             en: 'Share link' },
  copied:         { vi: 'Đã chép!',                 en: 'Copied!' },
  myCard:         { vi: 'Xem thẻ của tôi',          en: 'View my card' },
  invited:        { vi: 'Đã mời thành công',        en: 'Invited' },
  use:            { vi: 'Dùng',                     en: 'Use' },
  level:          { vi: 'Cấp',                      en: 'Lvl' },
